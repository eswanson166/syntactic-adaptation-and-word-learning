...
ggplot(all_exp_diff_action_prop) +
  ...
  xlab("Condition") +
  ylab("Diff. in mean prop. of looks before vs. after syntactic frame") +
  #geom_point(data = all_exp_diff_prop_action_trial, aes(x = condition, y = subj_diff_prop_action), shape = 20, size = .3) +
...
ggsave("../graphs/all_exp_diff_prop_action_dotplot.pdf", width = 8, height = 4)
```
